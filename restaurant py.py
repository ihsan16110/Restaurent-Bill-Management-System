...
lblInfo=Label(Tops,font=('helvetica',50,'bold'),text="The Chineese Palace",fg="Black",bd=10,anchor='w')
...
def Ref():
    ...
    CostBurger = CoBurger* 180
    CostSandwich=CoSandwich * 160

    CostofMeal= "Tk", str('%.2f' % (CostofFries+CostofDrinks+CostofNoodles+CostofSoup+CostBurger+CostSandwich))
